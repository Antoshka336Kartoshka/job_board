...
AUTH_USER_MODEL = 'main.BoardUser'
LOGIN_URL = 'login'
...
AWS_STORAGE_BUCKET_NAME = 'job-board-static'
...
DEFAULT_FILE_STORAGE = 'job_board.storage_backends.MediaStorage'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'job_board/debug.log'),
            'formatter': 'verbose'
        },
    },
    'loggers': {
